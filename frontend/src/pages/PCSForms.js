...
export default function PCSForms() {
  ...
  const groupedForms = useMemo(() => {
    ...
    // Keep categories in the order of categoryTitles first, then any extras
    const orderedKeys = [
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          <div className="space-y-12 md:space-y-14">
            {groupedForms.map(([category, categoryForms], catIndex) => (
              <motion.div key={category} {...fadeInUp} transition={{ delay: catIndex * 0.06 }}>
